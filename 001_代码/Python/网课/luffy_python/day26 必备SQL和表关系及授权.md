...
![image-20210530161018798](Python/基础/luffy_python/assets/image-20210530161018798.png)
...
![image-20210517184555990](Python/基础/luffy_python/assets/image-20210517184555990.png)
...
![image-20210517184600205](Python/基础/luffy_python/assets/image-20210517184600205.png)
...
![image-20210519093004885](Python/基础/luffy_python/assets/image-20210519093004885.png)
...
- 单表，单独一张表就可以将信息保存。
  ![image-20210519112309521](Python/基础/luffy_python/assets/image-20210519112309521.png)
- 一对多，需要两张表来存储信息，且两张表存在 `一对多` 或 `多对一`关系。
  ![image-20210519112430244](Python/基础/luffy_python/assets/image-20210519112430244.png)
- 多对多，需要三张表来存储信息，两张单表 + 关系表，创造出两个单表之间`多对多关系`。
  ![image-20210519113228664](Python/基础/luffy_python/assets/image-20210519113228664.png)
...
![image-20210520171902550](Python/基础/luffy_python/assets/image-20210520171902550.png)
...
![image-20210520171843289](Python/基础/luffy_python/assets/image-20210520171843289.png)
...
![image-20210530200222433](Python/基础/luffy_python/assets/image-20210530200222433.png)
...
![image-20210520173921204](Python/基础/luffy_python/assets/image-20210520173921204.png)
