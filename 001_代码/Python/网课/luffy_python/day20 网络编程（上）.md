...
![image-20210220091551058](Python/基础/luffy_python/assets/image-20210220091551058.png)
...
![image-20210204184431053](Python/基础/luffy_python/assets/image-20210204184431053-3881170.png)



**alex** 如何想要和室友 **于超** 进行收发数据，可以通过一根网线来进行连接，并进行数据的传输。

![image-20210204185417337](Python/基础/luffy_python/assets/image-20210204185417337-3881170.png)
...
![image-20210205143317465](Python/基础/luffy_python/assets/image-20210205143317465-3881170.png)
...
![image-20210204205902286](Python/基础/luffy_python/assets/image-20210204205902286-3890545.png)
...
![image-20210206092454106](Python/基础/luffy_python/assets/image-20210206092454106-3881170.png)



#### 1.1.4 小型企业基础网络架构

![image-20210206225844012](Python/基础/luffy_python/assets/image-20210206225844012.png)
...
![image-20210206231121896](Python/基础/luffy_python/assets/image-20210206231121896.png)

#### 1.1.6 互联网

![image-20210206231602247](Python/基础/luffy_python/assets/image-20210206231602247.png)
...
- 问题2：划分 网络地址 + 主机地址 的意义是什么？
  ...
  ![image-20210207001644433](Python/基础/luffy_python/assets/image-20210207001644433.png)
  ![image-20210207135331788](Python/基础/luffy_python/assets/image-20210207135331788.png)
...
![image-20210207143152690](Python/基础/luffy_python/assets/image-20210207143152690.png)
...
![image-20210207211646642](Python/基础/luffy_python/assets/image-20210207211646642.png)
...
![image-20210207215523168](Python/基础/luffy_python/assets/image-20210207215523168.png)



#### 1.2.5 端口

![image-20210207221334711](Python/基础/luffy_python/assets/image-20210207221334711.png)
...
![image-20210207230929229](Python/基础/luffy_python/assets/image-20210207230929229.png)
...
- 第三步：在自己电脑上找到DNS配置的地址（本地域名服务器），去这个地址寻找域名对应的IP，如果未命中，则执行下一步。
  ![image-20210207233253951](Python/基础/luffy_python/assets/image-20210207233253951.png)
...
- 第四步：去根域名服务器中询问（全球共13台根域名服务器，距离中国最近的一台是在日本）
  ...
  ![image-20210208102929953](Python/基础/luffy_python/assets/image-20210208102929953.png)
...
- 租一个域名
  ...
  ![image-20210208110607388](Python/基础/luffy_python/assets/image-20210208110607388.png)
...
- 域名解析
  ...
  ![image-20210208110829796](Python/基础/luffy_python/assets/image-20210208110829796.png)

  ![image-20210208110938038](Python/基础/luffy_python/assets/image-20210208110938038.png)
...
![image-20210208164809572](Python/基础/luffy_python/assets/image-20210208164809572.png)



![image-20210221190543727](Python/基础/luffy_python/assets/image-20210221190543727.png)



![image-20210221190426551](Python/基础/luffy_python/assets/image-20210221190426551.png)
