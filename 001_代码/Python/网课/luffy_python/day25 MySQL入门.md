...
![image-20210507211911641](Python/基础/luffy_python/assets/image-20210507211911641.png)

![image-20210508090834860](Python/基础/luffy_python/assets/image-20210508090834860.png)
...
![image-20210508102020237](Python/基础/luffy_python/assets/image-20210508102020237.png)
...
![image-20210528190629407](Python/基础/luffy_python/assets/image-20210528190629407.png)



# day25 MySQL入门

![image-20210528192555988](Python/基础/luffy_python/assets/image-20210528192555988.png)
...
![image-20210508103751068](Python/基础/luffy_python/assets/image-20210508103751068.png)
...
![image-20210508105417186](Python/基础/luffy_python/assets/image-20210508105417186.png)
...
![image-20210508120708175](Python/基础/luffy_python/assets/image-20210508120708175.png)



其实，MySQL的配置文件可以放在很多的目录，下图是配置文件的优先级：

![image-20210510150530193](Python/基础/luffy_python/assets/image-20210510150530193.png)
...
>>> "C:\Program Files\mysql-5.7.44-winx64\bin\mysqld.exe"  --initialize-insecure
```
...
![image-20210510151829891](Python/基础/luffy_python/assets/image-20210510151829891.png)
...
- 临时启动
  ...
  >>> "C:\Program Files\mysql-5.7.44-winx64\bin\mysqld.exe"
  ```

  ![image-20210510152448745](Python/基础/luffy_python/assets/image-20210510152448745.png)
...
- 制作windows服务，基于windows服务管理。
  ...
  ![image-20210510152702489](Python/基础/luffy_python/assets/image-20210510152702489.png)
  ...
  ![image-20210529225011045](Python/基础/luffy_python/assets/image-20210529225011045.png)

  ![image-20210529225043126](Python/基础/luffy_python/assets/image-20210529225043126.png)

  ![image-20210510152740268](Python/基础/luffy_python/assets/image-20210510152740268.png)
  ...
  ![image-20210510152809233](Python/基础/luffy_python/assets/image-20210510152809233.png)
...
![image-20210510153336093](Python/基础/luffy_python/assets/image-20210510153336093.png)

以后在开发时，肯定是要用Python代码来连接MySQL并且进行数据操作（后面讲）。

在安装MySQL时，其实也自动安装了一个工具（客户端），让我们快速实现连接MySQL并发送指令。

![image-20210510154446628](Python/基础/luffy_python/assets/image-20210510154446628.png)

注意：如果把bin目录加入环境变量，每次在运行命令时，就不用再重新输入绝对路径了。

![image-20210529225251803](Python/基础/luffy_python/assets/image-20210529225251803.png)
...
![image-20210510103342842](Python/基础/luffy_python/assets/image-20210510103342842.png)
...
![image-20210510161700478](Python/基础/luffy_python/assets/image-20210510161700478.png)



MySQL的配置文件按照优先级，会在以下目录中寻找：

![image-20210510161845843](Python/基础/luffy_python/assets/image-20210510161845843.png)
...
- 安装目录中自带 `mysql.server` 脚本（建议）
  ...
  ![image-20210510162854578](Python/基础/luffy_python/assets/image-20210510162854578.png)


  为了避免每次执行命令都需要些路径，可以将路径 `/usr/local/mysql/support-files`加入到环境变量中。

![image-20210510165107737](Python/基础/luffy_python/assets/image-20210510165107737.png)
...
![image-20210510171029083](Python/基础/luffy_python/assets/image-20210510171029083.png)

![image-20210510171004699](Python/基础/luffy_python/assets/image-20210510171004699.png)
...
![image-20210530001548192](Python/基础/luffy_python/assets/image-20210530001548192.png)
...
- 创建表结构
  ![image-20210511102323966](Python/基础/luffy_python/assets/image-20210511102323966.png)
