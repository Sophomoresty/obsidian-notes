...
![image-20210218184651385](Python/基础/luffy_python/assets/image-20210218184651385.png)
...
![image-20210218185849637](Python/基础/luffy_python/assets/image-20210218185849637.png)



如果程序不利用 计算机的多核优势，适合用多线程开发。

![image-20210218185953326](Python/基础/luffy_python/assets/image-20210218185953326.png)



常见的程序开发中，计算操作需要使用CPU多核优势，IO操作不需要利用CPU的多核优势，所以，就有这一句话：

- 计算密集型，用多进程，例如：大量的数据计算【累加计算示例】。需要用到 CPU 的多核
- IO密集型，用多线程，例如：文件读写、网络数据传输【下载抖音视频示例】。文件操作和下载网站, 不需要用到 CPU 的多核
...
![image-20210225102151570](Python/基础/luffy_python/assets/image-20210225102151570.png)
